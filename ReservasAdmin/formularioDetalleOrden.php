...
<?= Plato::getDatosEnArregloJS() ?>
    ...
    <body onLoad="presentarValor(document.formulario.codigoProducto.value); calcular()" >
		<div>
			...
			<form name="formulario" method="POST" action="PrincipalAdmin.php?CONTENIDOADMIN=ReservasAdmin/Reservas.php" enctype="multipart/form-data">
				<table >
				...
				<p><input type="button" name="accion" value="<?= $accion ?>" onclick="cargarDatos()"/>
			</form>
