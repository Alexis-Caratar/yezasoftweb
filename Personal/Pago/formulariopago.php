...
<center>
    ...
    <tr>
        <th>Valor hora extra</th><th><input class="form-control"  onchange="cargar()" id='valorhora'   type="number" placeholder="ingrese el valor" name="valorhoraextra" value="<?= $pago->getValorhoraextra() ?>" autofocus required> </th>
    </tr>
